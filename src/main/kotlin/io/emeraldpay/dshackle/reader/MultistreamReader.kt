...
open class MultistreamReader(
     ...
     */
    private val alwaysRequiredMatchers =
        listOf(
    ...
    override fun read(key: DshackleRequest): Mono<DshackleResponse> {
        val quorum =
            upstreams.getMethods().createQuorumFor(key.method).also {
    ...
    open fun createMatcher(
        ...
        val rightHeight: List<Selector.Matcher> =
            if (quorum is NotLaggingQuorum) {
