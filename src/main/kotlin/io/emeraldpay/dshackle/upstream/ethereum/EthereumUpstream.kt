...
abstract class EthereumUpstream(
    ...
    private val capabilities =
        if (options.providesBalance != false) {
    ...
    override fun getLabels(): Collection<UpstreamsConfig.Labels> = node?.let { listOf(it.labels) } ?: emptyList()

    /**
     * Access to subscriptions available on the upstream
     */
