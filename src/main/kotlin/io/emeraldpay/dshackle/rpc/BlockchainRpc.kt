...
class BlockchainRpc(
    ...
    private val describeMetric =
        Counter
            .builder("request.grpc.request")
            .tag("type", "describe")
            .tag("chain", "NA")
            .register(Metrics.globalRegistry)
    private val subscribeStatusMetric =
        Counter
            .builder("request.grpc.request")
            .tag("type", "subscribeStatus")
            .tag("chain", "NA")
            .register(Metrics.globalRegistry)
    private val failMetric =
        Counter
            .builder("request.grpc.fail")
    ...
    override fun nativeSubscribe(
        request: Mono<BlockchainOuterClass.NativeSubscribeRequest>,
    ): Flux<BlockchainOuterClass.NativeSubscribeReplyItem> =
        request
            .flatMapMany { req ->
                val metrics = chainMetrics.get(req.chain)
                metrics.nativeSubscribeMetric.increment()
                nativeSubscribe
                    .nativeSubscribe(Mono.just(req))
                    .doOnNext {
            ...
            .flatMapMany { request ->
                ...
                return@flatMapMany try {
                    trackAddress.find { it.isSupported(request) }?.let { track ->
                        ...
                        .error<BlockchainOuterClass.AddressBalance>(SilentException.UnsupportedBlockchain(chain))
                        .doOnSubscribe {
    ...
    override fun subscribeAddressAllowance(
        requestMono: Mono<BlockchainOuterClass.AddressAllowanceRequest>,
    ): Flux<BlockchainOuterClass.AddressAllowance> {
        return requestMono.flatMapMany { request ->
            ...
            return@flatMapMany try {
                if (trackErc20Allowance.isSupported(request)) {
                    ...
                    Flux
                        .error<BlockchainOuterClass.AddressAllowance>(SilentException.UnsupportedBlockchain(chain))
                        .doOnSubscribe {
    ...
    override fun getAddressAllowance(
        requestMono: Mono<BlockchainOuterClass.AddressAllowanceRequest>,
    ): Flux<BlockchainOuterClass.AddressAllowance> {
        return requestMono.flatMapMany { request ->
            val timer = StopWatch.createStarted()
    ...
    class RequestMetrics(
        ...
        val nativeCallMetric =
            Counter
                .builder("request.grpc.request")
                .tag("type", "nativeCall")
                .tag("chain", chain.chainCode)
                .register(Metrics.globalRegistry)
        val nativeCallRespTimeMetric =
            Timer
                .builder("request.grpc.response.time")
                .tag("type", "nativeCall")
                .tag("chain", chain.chainCode)
                .publishPercentileHistogram()
                .register(Metrics.globalRegistry)
        val nativeCallRespCountMetric =
            Counter
                .builder("request.grpc.response")
                .tag("type", "nativeCall")
                .tag("chain", chain.chainCode)
                .register(Metrics.globalRegistry)
        val nativeCallErrRespMetric =
            Counter
                .builder("request.grpc.response.err")
                .tag("type", "nativeCall")
                .tag("chain", chain.chainCode)
                .register(Metrics.globalRegistry)
        val nativeSubscribeMetric =
            Counter
                .builder("request.grpc.request")
        ...
        val nativeSubscribeRespMetric =
            Counter
                ...
                .tag("chain", chain.chainCode)
                .register(Metrics.globalRegistry)
        val subscribeHeadMetric =
            Counter
                .builder("request.grpc.request")
                .tag("type", "subscribeHead")
                .tag("chain", chain.chainCode)
                .register(Metrics.globalRegistry)
        val subscribeHeadRespMetric =
            Counter
                .builder("request.grpc.reply")
                .tag("type", "subscribeHead")
                .tag("chain", chain.chainCode)
                .register(Metrics.globalRegistry)
        val subscribeTxMetric =
            Counter
                .builder("request.grpc.request")
        ...
        val subscribeBalanceMetric =
            Counter
                ...
                .tag("chain", chain.chainCode)
                .register(Metrics.globalRegistry)
        val subscribeBalanceRespMetric =
            Counter
                .builder("request.grpc.reply")
                .tag("type", "subscribeBalance")
                .tag("chain", chain.chainCode)
                .register(Metrics.globalRegistry)
        val getBalanceMetric =
            Counter
                .builder("request.grpc.request")
                .tag("type", "getBalance")
                .tag("chain", chain.chainCode)
                .register(Metrics.globalRegistry)
        val getBalanceRespTimeMetric =
            Timer
                .builder("request.grpc.response.time")
                .tag("type", "getBalance")
                .tag("chain", chain.chainCode)
                .publishPercentileHistogram()
                .register(Metrics.globalRegistry)
        val getBalanceRespCountMetric =
            Counter
                .builder("request.grpc.response")
                .tag("type", "getBalance")
                .tag("chain", chain.chainCode)
                .register(Metrics.globalRegistry)
        val getAddressAllowanceMetric =
            Counter
                .builder("request.grpc.request")
                .tag("type", "getAllowance")
                .tag("chain", chain.chainCode)
                .register(Metrics.globalRegistry)
        val getAddressAllowanceRespCountMetric =
            Counter
                .builder("request.grpc.response")
                .tag("type", "getAllowance")
                .tag("chain", chain.chainCode)
                .register(Metrics.globalRegistry)
        val getAddressAllowanceRespTimeMetric =
            Timer
                .builder("request.grpc.response.time")
                .tag("type", "getAllowance")
                .tag("chain", chain.chainCode)
                .publishPercentileHistogram()
                .register(Metrics.globalRegistry)
        val subscribeAddressAllowanceMetric =
            Counter
                .builder("request.grpc.request")
                .tag("type", "subscribeAllowance")
                .tag("chain", chain.chainCode)
                .register(Metrics.globalRegistry)
        val subscribeAddressAllowanceRespMetric =
            Counter
                .builder("request.grpc.response")
                .tag("type", "subscribeAllowance")
                .tag("chain", chain.chainCode)
        ...
        val estimateFeeRespTimeMetric =
            Timer
                ...
                .publishPercentileHistogram()
                .register(Metrics.globalRegistry)
        val estimateFeeRespCountMetric =
            Counter
                .builder("request.grpc.response")
                .tag("type", "estimateFee")
                .tag("chain", chain.chainCode)
