...
class AccessRecordBaseBuilderTest : ShouldSpec({
    ...
    class TestEventBuilder :
        ...
        override fun getT(): TestEventBuilder {
            return this
        }
        ...
        override fun onReply(msg: BlockchainOuterClass.NativeCallReplyItem): TestEvent {
            return TestEvent(requestDetails)
        }
    }
    ...
    should("Truncate up user agent to 128 characters max") {
        ...
        with(act.request.remote!!) {
            ...
            userAgent shouldBe "0123456_1_0123456_2_0123456_3_0123456_4_0123456_5_0123456_6_0123456_7_0123456_8_0123456_9_0123456_0_0123456_1_0123456_2_0123456_"
        }
    }
})
