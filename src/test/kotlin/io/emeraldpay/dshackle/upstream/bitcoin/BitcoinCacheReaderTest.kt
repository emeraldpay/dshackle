...
class BitcoinCacheReaderTest :
    ShouldSpec({
        ...
        should("Tx request should accept params without verbosity") {
            ...
            every {
                reader.readRawTx(
                    TxId.from("37ba87c0c8735341f4a134411cf3c54bc16c734882d3c7eb935d1423914fc88c"),
                    false,
                )
            } returns
            ...
            val act =
                reader
                    .processGetTxRequest(
                        DshackleRequest(
                            "getrawtransaction",
                            listOf("37ba87c0c8735341f4a134411cf3c54bc16c734882d3c7eb935d1423914fc88c"),
                        ),
            ...
            val act =
                reader
                    .processGetTxRequest(
                        DshackleRequest(
                            "getrawtransaction",
                            listOf("37ba87c0c8735341f4a134411cf3c54bc16c734882d3c7eb935d1423914fc88c", false),
                        ),
                    ).block(Duration.ofSeconds(1))
            ...
            val act =
                reader
                    .processGetTxRequest(
                        DshackleRequest(
                            "getrawtransaction",
                            listOf("37ba87c0c8735341f4a134411cf3c54bc16c734882d3c7eb935d1423914fc88c", true),
                        ),
                    ).block(Duration.ofSeconds(1))
