...
class DataReadersTest : ShouldSpec({

    val blockJson = DataReadersTest::class.java.classLoader.getResourceAsStream("bitcoin/block-626472.json").readAllBytes()
    val source = mockk<DshackleRpcReader>()
    every { source.read(DshackleRequest("getblock", listOf("0000000000000000000889c2e52ca5e1cecac60bce9a3754201a7a9a67791e90", 1))) } returns
    ...
    should("fetch a block") {
        ...
        val act = dataReaders.getBlock(BlockId.from("0000000000000000000889c2e52ca5e1cecac60bce9a3754201a7a9a67791e90"), 1)
    ...
    should("fetch a parsed block") {
        ...
        val act = dataReaders.getBlockJson(BlockId.from("0000000000000000000889c2e52ca5e1cecac60bce9a3754201a7a9a67791e90"))
            .block(Duration.ofSeconds(1))
    ...
    should("fetch a parsed block by height") {
        ...
        val act = dataReaders.getBlockJson(626472)
            .block(Duration.ofSeconds(1))
