...
class DshacklePendingTxesSourceTest : ShouldSpec({
    ...
    should("Produce values") {
        ...
        val server = InProcessServerBuilder.forName(uniqueName)
            .directExecutor()
            .addService(object : BlockchainGrpc.BlockchainImplBase() {
                override fun nativeSubscribe(request: BlockchainOuterClass.NativeSubscribeRequest, responseObserver: StreamObserver<BlockchainOuterClass.NativeSubscribeReplyItem>) {
            ...
            .build().start()
        val channel = InProcessChannelBuilder.forName(uniqueName)
            .directExecutor()
            .build()
        ...
        val txes = pending.connect().take(3)
        ...
        txes.map { it.toHex() } shouldBe listOf(
            "0xa61bab14fc9720ea8725622688c2f964666d7c2afdae38af7dad53f12f242d5c",
            "0x911548eb0f3bf353a54e03a3506c7c3e747470d6c201f03babbc07ff6e14cd6e",
            "0x9a9d4618b12d36d17a63d48c5b5efc05b461feead124ddd86803d8bca4015248",
        )
