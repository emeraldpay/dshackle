    ...
    ShouldSpec({
        ...
        context("eth_getBlockByHash") {
            ...
            should("Use Full Blocks to rebuild transactions when requested") {
                ...
                val act =
                    reader
                        .read(DshackleRequest("eth_getBlockByHash", listOf(blockId.toHexWithPrefix(), true)))
            ...
            should("Return nothing is full block not requested") {
                val act =
                    reader
                        .read(DshackleRequest("eth_getBlockByHash", listOf(blockId.toHexWithPrefix(), false)))
                        .block(Duration.ofSeconds(1))
        ...
        context("eth_getBlockByNumber") {
            ...
            should("Use Full Blocks to rebuild transactions when requested and no height is cached") {
                ...
                val act =
                    reader
                        .read(DshackleRequest("eth_getBlockByNumber", listOf("0x65", true)))
                        .block(Duration.ofSeconds(1))
            ...
            should("Return nothing when old block requests") {
                ...
                val act =
                    reader
                        .read(DshackleRequest("eth_getBlockByNumber", listOf("0x25", true)))
                        .block(Duration.ofSeconds(1))
