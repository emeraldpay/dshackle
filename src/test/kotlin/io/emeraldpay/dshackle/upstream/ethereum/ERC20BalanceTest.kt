...
class ERC20BalanceTest :
    ShouldSpec({

        should("Get balance from upstream") {
            val api =
                ReaderMock<JsonRpcRequest, JsonRpcResponse>()
                    .with(
                        JsonRpcRequest(
                            "eth_call",
                            listOf(
            ...
            val act =
                query
                    .getBalance(upstream, token, Address.from("0x16c15c65ad00b6dfbcc2cb8a7b6c2d0103a3883b"))
        ...
        should("Get balance from api source") {
            ...
            val act =
                query
                    .getBalance(apiSource, token, Address.from("0x16c15c65ad00b6dfbcc2cb8a7b6c2d0103a3883b"))
                    .block(Duration.ofSeconds(1))
