...
class UpstreamsConfigTest : ShouldSpec({
    ...
    context("Labels") {
        ...
        context("Equal") {
            ...
            should("equal single label") {
                val labels1 = UpstreamsConfig.Labels().also {
                    it["foo"] = "bar"
                }
                val labels2 = UpstreamsConfig.Labels().also {
                    it["foo"] = "bar"
                }
        ...
        context("toString") {
            ...
            should("value for one label") {
                val labels = UpstreamsConfig.Labels().also {
                    it["foo"] = "bar"
                }
