...
class ReadRpcJsonTest : ShouldSpec({
    ...
    should("Parse multi batch") {
        val act = reader.apply("""[{"jsonrpc":"2.0", "method":"net_peerCount", "id":"xdd", "params":[]}, {"jsonrpc":"2.0", "method":"foo_bar", "id":4, "params":[143, false]}]""".toByteArray())
        act.type shouldBe ProxyCall.RpcType.BATCH
